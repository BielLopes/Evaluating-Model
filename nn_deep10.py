...
class NeuralNet(nn.Module):
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.lh6 = nn.Linear(hidden_size, hidden_size)
        self.lh7 = nn.Linear(hidden_size, hidden_size)
        self.lh8 = nn.Linear(hidden_size, hidden_size)
        self.lh9 = nn.Linear(hidden_size, hidden_size)
        self.lh10 = nn.Linear(hidden_size, hidden_size)
